...
categories:
  - sample
  - post
description: This page contains some highlighted source code
hero: images/demo_1.jpg
slug: posts/a-post-with-source-code
---
...
```bash
$ cd ~
$ chmod a+x my_shell.sh
$ ./my_shell.sh "my name" "my hobby"
```
...
try {
  ...
  // I don't wanna do anything about this error
}
```
